CREATE TABLE [dbo].[SE_CSS_APPROVED_WORKORDER] (
    ...
    CONSTRAINT [PK_SE_CSS_APPROVED_WORKORDER] PRIMARY KEY NONCLUSTERED ([Id] ASC),
    CONSTRAINT [FK_WO_approved] FOREIGN KEY ([Approved_Id]) REFERENCES [dbo].[SE_CSS_APPROVED_DATA] ([Id])
);
