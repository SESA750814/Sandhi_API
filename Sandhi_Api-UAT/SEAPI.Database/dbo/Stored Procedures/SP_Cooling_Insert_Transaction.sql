...
CREATE procedure [dbo].[SP_Cooling_Insert_Transaction]
...
--,@W_Year = year(format(try_convert(datetime,Completed_On),'dd/MM/yyyy '))   from Cooling_RAW_DUMP 
...
INSERT INTO [dbo].[Cooling_Work_Order] 
           ([Work_Order_Number]
           ,[Case]
     ...
     Select 
		   ...
		   ,Services_Business_Unit
		   from [dbo].[Cooling_RAW_DUMP]  Where Is_Billable like 'NO'
